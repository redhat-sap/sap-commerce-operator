...
// +kubebuilder:rbac:groups=hybris.hybris.org,resources=hybrisbases,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=hybris.hybris.org,resources=hybrisbases/status,verbs=get;update;patch

func (r *HybrisBaseReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	_ = context.Background()
	_ = r.Log.WithValues("hybrisbase", req.NamespacedName)
